...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\Column(length: 255)]
    #[Assert\Length(min:10,max:255,minMessage:"Votre introduction doit faire plus de 10 caractères")]
    private ?string $introduction = null;

    #[ORM\Column(type: Types::TEXT)]
    #[Assert\Length(min:100,minMessage:"Votre description doit faire plus de 10 caractères", maxMessage:"Votre description ne doit pas faire plus de 255 caractères")]
    ...
    /**
     * Permet de créer un slug automatiquement avec le nom et le prénomd de l'utilisateur
     *
     * @return void
     */
    #[ORM\PrePersist]
